namespace Common.Utilities
{
    public static class StringExtensions
    {
        ...
        //123456 => "123,123ریال"
        public static string ToCurrency(this int value) => value.ToString("C0");
        ...
        public static string CleanString(this string str) => str.Trim().FixPersianChars().Fa2En().NullIfEmpty();
